...
import VisitLine from '../../View/OtherComponents/VisitLine';
import { VisitContext } from '../../Model/VisitContext';
import { PatientContext } from '../../Model/PatientContext';
import NoContextModal from '../../View/Modals/NoContextModal';
            ...
            <div style={style.box}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingLeft: '2%' }}>
                    ...
                    <div style={{ display: 'flex', gap: 20 }}>
                        <div>
                            <Link to={'/newVisit'} className="btn btn-primary btn-lg" style={{ fontSize: 30, }} onClick={() => createNewVisit(true)} >
                                Nuova visita  <img src={newFile} alt="search" width={38} style={{ filter: 'invert(100%)' }} />
                            </Link>
                        </div>
                        <div>
                            <Link to={'/newVisit'} className="btn btn-primary btn-lg" style={{ fontSize: 30 }} onClick={() => createNewVisit(false)} >
                                Trascrivi visita <img src={newEvent} alt="search" width={38} style={{ filter: 'invert(100%)' }} />
                            </Link>
                        </div>
                ...
                <div style={{ height: '70vh', overflow: 'auto', textAlign: 'left', borderRadius: '15px', border: '0.5px solid black' }}>
