    ...
    return (
        <div style={styles.container} ref={ref}>
            ...
            <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between' }}>
                <div>
                    <div style={{ border: '0.5px solid lightgray', alignSelf: 'flex-start', padding: 5 }}>
                        <p style={styles.text}>Patient: {patient.name} {patient.surname}</p>
                        <p style={styles.text}>Birthdate: {format(patient.birthdate, 'dd - MM - y')}</p>
                        <p style={styles.text}>Age: {(new Date().getFullYear() - patient.birthdate.getFullYear())}</p>
                        ...
                        <p style={styles.text}>Prothesis: {patient.prothesis.toString()}</p>
                    </div>
                </div>
                <div>
